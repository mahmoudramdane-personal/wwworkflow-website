    ...
    <>
      <footer
        ...
        <div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
          ...
          <div className="flex flex-wrap justify-center border-b mb-5 gap-4 md:gap-0">
            <a className=" font-alt text-white mx-0 md:mx-10 " href='https://www.linkedin.com/company/afterworkworkflow' aria-label="LinkedIn">
              <svg
            ...
            <a className="font-alt text-white mx-0 md:mx-10 " aria-label="Twitter">
            ...
            <a className="font-alt text-white mx-0 md:mx-10 " href='https://www.instagram.com/afterwork.workflow/' aria-label="Instagram">
            ...
            <a className=" font-alt text-white mx-0 md:mx-10 " aria-label="Facebook">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5 mb-5" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"></path>
              </svg>
            </a>

            <a className="font-alt text-white mx-0 md:mx-10 ">
              <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5 mb-5" viewBox="0 0 24 24">
                <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
              </svg>
            </a>

            <a className="font-alt text-white mx-0 md:mx-10 " href='https://www.instagram.com/afterwork.workflow/' >
