    ...
    <header className="bg-cgrey px-2 sm:px-4 py-2.5 dark:bg-gray-900 sticky w-full z-20 top-0 left-0  dark:border-gray-600">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
          <a href="/" className="flex items-center">
            <Image src={logo} alt="Afterwork Workflow Logo" width={75} height={30} priority />
          </a>

        <div className='flex md:order-2' >

          <button data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden focus:outline-none  dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-sticky" aria-expanded={open} onClick={() => setOpen(!open)} aria-label="Toggle navigation menu">
