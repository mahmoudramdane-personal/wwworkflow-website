...
That's what it took to learn Grasshopper in 2017. And I have a strong opinion about it: a student in 2026 shouldn't have to squint through blurry YouTube lectures to learn this.

---

I was 20, studying architecture at the National School of Architecture in Morocco. Nobody at my school knew what Grasshopper was. Nobody was teaching computational design. But I kept seeing what big firms were doing online — Zaha Hadid, Foster + Partners — and I knew: this is the direction architecture is headed. I just had no way to get there.

So I did what any desperate student does. I went to YouTube.

## The Wrong Way

The tutorials I found were silent. Just screen recordings of someone connecting nodes, fast, with no explanation. Monkey-see, monkey-do. I'd recreate the shapes, but I had no idea why they worked. You can't build anything original that way. All I produced was copies of copies.
...
I also asked strangers for help. Without them, I would have quit.

Three years of struggling before I took any real tutoring. But here's the thing: if I hadn't done those three years of research first, the tutoring wouldn't have worked. It would have been overwhelming. The struggle built the context.
...
We're in 2026. Architecture schools should be teaching this to second or third-year students. Computational design isn't a niche skill — it's the equivalent of coding for architects. You're going to spend decades using software and managing data. You need to understand how it works under the hood.

A course in geometry hierarchies, parametric logic, and systems thinking should be as fundamental as construction materials or architectural history. Right now, most schools don't offer it. Students are left to find a blurry 240p lecture from a professor who doesn't know they exist.

That's not good enough anymore.

---

*I help designers and architects conceive using Grasshopper and computational design at wwworkflows.com. Follow me on Instagram at @afterwork.workflow for daily tips. If your firm wants to transition to digital workflows, email me, we'll get it from there.*

*This article is part of a series on learning computational design. Next up: data trees and how to build complex geometries from simple rules.*`,
    category: "Insights",
    date: "2026-06-04",
    thumbnail: null,
    order: 1,
